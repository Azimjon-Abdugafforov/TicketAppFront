#pragma checksum "C:\Users\acer\source\repos\TicketAppFront\TicketAppFront\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a6914a10433f9e628f3433d30fc1fdc69e142802"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a6914a10433f9e628f3433d30fc1fdc69e142802", @"/Views/Home/Index.cshtml")]
...
<script type=""text/javascript"">
    ...
    var baseURL = 'https://localhost:44303/api/'
        angular
                ...
                $scope.order =
                    {
                        ...
                        pickUpAddress : '',
                        destinationAddress : '',
                        orderDate :'2012-06-18T10:34:09'
                    };
                $scope.AddTaxiOrder = function()
                {
                    $http.post('https://localhost:44303/api/torders/', $scope.order)
                        .then(function (res)
                        {
                            $location.path('/')
                        });
           ...
           ");
            WriteLiteral(@"     $http.get('https://localhost:44303/api/torders/' + $routeParams.orderId)
                    .then(function (res)
                    {
            ...
            .controller('EditDeleteController', ['$scope', '$http','$location', '$routeParams', function ($scope, $http, $location, $routeParams)
            {
                ...
                $http.get('https://localhost:44303/api/torders/' + $routeParams.orderId)
                    .then(function (res)
                    {
                        $scope.edit = res.data;
                    });
                ...
                $scope.Edit = function () {
                    $http.put('https://localhost:44303/api/torders/' + $routeParams.orderId, $scope.edit)
                        .then(function (res) {
                            $location.path('/');
                        });
                };
        ...
        ");
            WriteLiteral(@"            $http.delete('https://localhost:44303/api/torders/' + $routeParams.orderId, $scope.edit)
                        .then(function (res) {
                            $location.path('/');
                        });
                };
