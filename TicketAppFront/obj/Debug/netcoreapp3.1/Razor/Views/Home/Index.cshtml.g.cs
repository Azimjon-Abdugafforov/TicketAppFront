#pragma checksum "C:\Users\acer\source\repos\TicketAppFront\TicketAppFront\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2f5ef46cecb9291b7cc87844dee37e11d2664569"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2f5ef46cecb9291b7cc87844dee37e11d2664569", @"/Views/Home/Index.cshtml")]
    ...
    var baseURL = 'https://localhost:44303/api/'
        angular
            ...
            .controller('DetailsController', ['$scope', '$http', '$routeParams', function ($scope, $http, $routeParams)
            {
             ...
             ");
            WriteLiteral(@"   $http.get('https://localhost:44303/api/tickets/' + $routeParams.orderId)
                    .then(function (res)
                    {
          ...
          ");
            WriteLiteral(@"          $http.delete('https://localhost:44303/api/tickets/' + $routeParams.orderId, $scope.edit)
                        .then(function (res) {
                            $location.path('/');
                        });
                };
